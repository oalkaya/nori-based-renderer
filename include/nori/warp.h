...
public:
    ...
    /// Uniformly sample a vector on a unit cylinder
    ...
    static Vector3f squareToGTR2a(const Point2f &sample, float ax, float ay);
    static float squareToGTR2aPdf(const Vector3f &m, float ax, float ay);
};
